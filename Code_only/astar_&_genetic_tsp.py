...
if __name__ == "__main__":
    ...
    api_sol =sofia_astar.API(source_astar,city_to_railway[starting_city],max_time,max_cost)
    if not api_sol:
    ...
    if optimal_tour:
        ...
        print("--------------------------------------")
        print("--------------------------------------")
        print("Genetic Algo path :")
        for i in range(len(optimal_tour)):
            print(i + 1, optimal_tour[i])
        print("Total time:", total_time+api_sol[1])
        print("Total cost:", total_cost+api_sol[2])
        print("Average rating:", average_rating)
        print("Best generation:", generation_no)
    else:
