...
edge_color = "skyblue"
orange_nodes = ['Bhubaneswar Railway Station(Bhubaneswar)', 'Cuttack Junction Railway Station(Cuttack)','Howrah Junction Railway Station(Kolkata)','Visakhapatnam Railway Station(Visakhapatnam)']  # List of nodes to be colored orange
orange_edge_nodes = [('Bhubaneswar Railway Station(Bhubaneswar)', 'Cuttack Junction Railway Station(Cuttack)'), ('Cuttack Junction Railway Station(Cuttack)', 'Howrah Junction Railway Station(Kolkata)'),('Howrah Junction Railway Station(Kolkata)','Visakhapatnam Railway Station(Visakhapatnam)')]  # List of edges to be colored orange
...
nx.draw(
    ...
    pos,
    with_labels=True,
    node_color=[node_color if node not in orange_nodes else 'orange' for node in G2.nodes()],
    node_size=100,
    font_size=10,
